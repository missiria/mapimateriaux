...
$charanglemax  = 2;     // Angle maximum de rotation des caracteres (0-360)
...
$noisepxmin = 1;      // Bruit: Nb minimum de pixels aléatoires
$noisepxmax = 1;      // Bruit: Nb maximum de pixels aléatoires
