	...
	************************************************************************************************************/	
	...
	var opacitySpeed = 5;	// Speed of opacity - switching between large images - Lower = faster
	...
	function showPreview(imagePath,inputObj,accroche, NomProd, tolink)
	{	

		
		if(DHTMLgoodies_currentActiveImage){
			if(DHTMLgoodies_currentActiveImage==inputObj.getElementsByTagName('IMG')[0]){
				document.getElementById('accroche').innerHTML = accroche;	
				document.getElementById('NomProd').innerHTML = NomProd;	
				document.getElementById('link').innerHTML = tolink;	
