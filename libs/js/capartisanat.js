...
function affiche_caracteristique(id){
	...
	document.getElementById('content-tabs').innerHTML = '<img src="../images/loading2.gif" alt="" class="loading-ajax" />';
...
function personaliser_produit(id){
	...
	document.getElementById('blocpersonnaliser').innerHTML = '<img src="../images/loading2.gif" alt="" class="loading-ajax" />';
...
function changeimgarticle(){
 ...
 urlid = href2.substring(href2.indexOf('id=')+3,href2.length);
